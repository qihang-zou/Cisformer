...
def main():
    ...
    # path
    parser.add_argument('-d', '--data_dir', type=str, default=None, help="Preprocessed file end with '.pt'. You can specify the directory or filename of certain file")
    ...
    parser.add_argument('-c', '--config_file', type=str, default="atac2rna_config.yaml", help="config file for model parameters")
