## conda activate /fs/home/jiluzhang/softwares/miniconda3/envs/scTranslator
import scanpy as sc
import pandas as pd
...
def main(rna_file, atac_file, save_dir=None, test_percent=0.2, seed=2023, divide=True):
    ...
    genes = pd.read_table('human_genes.tsv', names=['gene_ids', 'gene_name'])
