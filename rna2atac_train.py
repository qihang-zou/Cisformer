...
def main():
    ...
    parser.add_argument('--train_data_dir', type=str, default=None, help="dir of preprocessed paired train data")
    parser.add_argument('--val_data_dir', type=str, default=None, help="dir of preprocessed paired val data")
    ...
    for e in range(epoch): #Luz for e in total_box:
        ...
        accelerator.save_model(model, os.path.join(save_path, f"{start_date}_{save_name}_{e+1}")) #Luz accelerator.save_model(model, os.path.join(save_path, f"{start_date}_{save_name}"))
